...
class CodeDataset(Dataset):
    ...
    def __init__(self, args, dataset_name, mode, task=None, language=None, split=None, clone_mapping=None, task_id=None):
        """
        ...
        # TODO: mode指定dataset下文件夹（和enums-1一起修改）
        # 把finetune数据集改到这里，用load_dataset_from_dir
