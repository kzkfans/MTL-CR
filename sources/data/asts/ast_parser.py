...
LANGUAGE = {enums.LANG_GO: Language(tsgo.language()),
            enums.LANG_JAVASCRIPT: Language(tsjs.language()),
            enums.LANG_PYTHON: Language(tspython.language()),
            enums.LANG_JAVA: Language(tsjava.language()),
            enums.LANG_PHP: Language(tsphp.language_php()),
            enums.LANG_RUBY: Language(tsruby.language()),
            enums.LANG_C_SHARP: Language(tscs.language())}
...
def generate_single_ast_nl(source, lang, name=None, replace_method_name=False):
    ...
    Args:
        lang (str): Source code language
        name (str): optional, name of method/function
        replace_method_name (bool): Whether to replace method name
         and returns a version that without names additionally
